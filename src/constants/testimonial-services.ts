...
import { PorfolioLogo } from '@/components/icons/portfolio-logo';
...
export const TESTIMONIAL_SERVICES = [
  ...
  [
    ...
    PorfolioLogo,
    'CTO | Porfolio Insider',
    'Don',
    'I highly recommend Techstacks for anyone seeking top-notch web services development. Their commitment to excellence, technical prowess, and dedication to client satisfaction make them a top choice for web development projects. Thank you for a job well done!',
  ],
  [
