    ...
    <div className="flex-col">
      <div className=" flex justify-center w-full  bg-gradient-to-tl from-black from-10% via-amber-600 via-100% to-orange-500 to-40% py-5 md:py-10">
        <div className=" max-w-screen-xl">
          <H2 className="text-center font-bold text-2xl xmd:text-3xl md:text-4xl lg:text-5xl text-background dark:text-foreground drop-shadow-3xl">
            Grow Your Career
            <br />
      ...
      <div className="bg-black flex justify-center p-5 py-10">
        <div className="max-w-screen-xl flex-col w-full ">
          <H2 className=" font-bold pb-5 text-background dark:text-foreground text-xl md:text-4xl text-center">
