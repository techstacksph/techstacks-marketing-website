...
export default function PortfoliosHero() {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-8 items-center min-h-[inherit] justify-center">
        <H1 className="text-center">
          Showcasing our Digital{' '}
          <span className="text-primary-static">Excellence</span>
        </H1>
        <Subheading className="text-center">
          Explore our digital portfolio, a fusion of cutting-edge innovation and
          tangible impact, reflecting our commitment to pushing boundaries and
          delivering results.
        </Subheading>
