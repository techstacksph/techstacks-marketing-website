      ...
      <Section>
        <div className="flex flex-col gap-14">
          <div className="flex flex-col gap-8 items-center justify-center lg:flex-row">
            <h3 className="text-2xl  font-semibold text-center lg:w-1/2 lg:font-bold lg:text-4xl lg:text-left xl:text-5xl">
              A Trusted Connection to Our Partners
            </h3>
            <p className="text-base font-normal text-muted text-center lg:w-1/2 lg:text-left lg:text-lg">
