...
const testimonial_contents = {
  ...
  img: '/assets/img/testimonial/testi-5.1.png',
  testi_items: [
    {
      ratings: [1, 2, 3, 4, 5],
      desc: 'Wow. What a great experience with this copywriter. Techstacks Ph is a very talented digital agnecy. yesterday. I got his first Email that was amazing... talent and wonder full design skills',
      name: 'Floyd Miles',
