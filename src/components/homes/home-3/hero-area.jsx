...
const hero_contents = {
  title: (
    <>
      Techstacks Ph helps your teams move work{' '}
  ...
  text: 'At Techstacks Ph we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast efficiency',
