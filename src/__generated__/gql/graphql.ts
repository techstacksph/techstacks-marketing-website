...
/** Block of type Multi Media (multi_media_model) */
export type MultiMediaModelRecord = RecordInterface & {
  __typename?: 'MultiMediaModelRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
  ...
  id: Scalars['ItemId']['output'];
  singleImage?: Maybe<AltFileField>;
};

/** Block of type Multi Media (multi_media_model) */
export type MultiMediaModelRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type GetBlogsQueryVariables = Exact<{
  offset?: InputMaybe<Scalars['IntType']['input']>;
  search: Scalars['String']['input'];
  size?: InputMaybe<Scalars['IntType']['input']>;
}>;
...
export type GetBlogsQuery = {
  ...
  meta: { __typename?: 'CollectionMetadata'; totalBlogs: number };
};
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  alias: { kind: 'Name', value: 'totalBlogs' },
