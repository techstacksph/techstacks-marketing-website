...
const initialState = {
  reviews:[
    {img:'/assets/img/product/client.png',name:'SIARHEI DZENISENKA',date:'5/15/2022, 2:53:39 PM',
    ...
    {img:'/assets/img/product/client-2.png',name:'TOMMY JARVIS',date:'3/05/2022, 3:53:39 PM',
    ...
    {img:'/assets/img/product/client-3.png',name:'JOHNNY CASH',date:'1/09/2022, 5:53:39 PM',
